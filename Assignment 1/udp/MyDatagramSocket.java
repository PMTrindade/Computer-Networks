...
public class MyDatagramSocket extends DatagramSocket {
	...
	private static final int _PROB_MSG_LOSS = 50; // 1% packet loss
	private static final int _IF_BANDWIDTH = 2000000; // 2 Mbps
	private static final double _PPT_JITTER = 0.10; // factor de jitter no tempo
													// de propagacao
	private static final double _PPT_AVERAGE = 200; // tempo de propagacao medio
													// em mili segundos
